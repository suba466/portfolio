...
const Hero = () => {
    return (
        <section id="home" className="min-h-[75vh] flex flex-col justify-center pt-12 pb-12 md:pt-16 md:pb-20 items-center text-center px-4 md:px-16 relative overflow-hidden bg-transparent transition-colors duration-300">
            {/* Background Effects */}
            ...
            >
                ...
                <div className="flex gap-6 justify-center flex-wrap">
                    ...
                    <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                        href={resume}
                        download="Suba_shree_Resume.pdf"
