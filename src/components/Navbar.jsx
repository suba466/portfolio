...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 px-4 md:px-16 py-4 transition-all duration-300 ${scrolled ? 'backdrop-blur-xl bg-slate-900/80 border-b border-white/10' : 'bg-transparent'}`}>
